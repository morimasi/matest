    ...
    <>
      ...
      <div className="bg-[--bg-component] backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-2xl border border-[--border-color] mt-8 printable-area">
        ...
        <div className="bg-[--bg-interactive-muted] p-4 sm:p-8 rounded-b-2xl non-printable-bg">
          <div id="quiz-paper" ref={quizRef} style={quizContentStyle} className={`quiz-paper bg-white ${settings.showBorder ? 'bordered' : ''} ${settings.pageStyle}`}>
       ...
       <style>{`
        ...
        /* Ensure quiz paper text remains dark even in dark mode for print fidelity */
        .dark .quiz-paper, .dark .quiz-paper * {
            color: #1e293b; /* slate-800 */
        }
        .dark .quiz-paper .bg-green-100 { background-color: #dcfce7 !important; }
        .dark .quiz-paper .text-green-800 { color: #166534 !important; }
