...
Örnek Soru:
{
    ...
    "soru_metni": "Bir yılda 10 ay vardır.",
    "dogru_cevap": "Yanlış",
    ...diğer alanlar
}
`;
...
Örnek Soru:
{
    "soru_tipi": "bosluk_doldurma",
    "soru_metni": "Bir saat, ___ dakikadır.",
    "dogru_cevap": "60",
    ...diğer alanlar
}
`;
...
Örnek Soru:
{
    ...
    "dogru_cevap": "C",
    "yanlis_secenek_tipleri": ["Birlik ve onluk kavram yanılgısı", "Rakamların yerini karıştırma"],
    ...diğer alanlar
}
`;
            specificProperties = {
