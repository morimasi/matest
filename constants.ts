  ...
  // 4. Sınıf
  {
    ...
    units: [
      ...
      { 
        ...
        name: "Cebir", 
        kazanimlar: [
          { id: "M.4.1.1.2", name: "Sayı örüntülerindeki ilişkiyi bulur ve örüntüyü genişletir."}
        ]
      },
    ],
  },
  // 5. Sınıf
  {
    ...
    units: [
      ...
      { 
        ...
        name: "Ölçme", 
        kazanimlar: [
          { id: "M.5.2.3.1", name: "Uzunluk ölçme birimlerini (km, m, cm, mm) birbirine dönüştürür." },
          { id: "M.5.2.3.2", name: "Zaman ölçü birimlerini (yıl, ay, hafta, gün) birbirine dönüştürür." },
          { id: "M.5.2.3.3", name: "Uzunluk ve zaman ölçme birimleri ile ilgili problemleri çözer." },
          { id: "M.5.2.4.1", name: "Dikdörtgenin alanını hesaplamayı gerektiren problemleri çözer." },
          { id: "M.5.2.4.2", name: "Üçgenin alanını hesaplar." },
          { id: "M.5.2.5.1", name: "Dikdörtgenler prizmasının yüzey alanını hesaplar."},
          { id: "M.5.2.5.2", name: "Dikdörtgenler prizmasının hacmini hesaplar." },
        ]
      },
      { 
        id: "5-4", 
        name: "Veri", 
        kazanimlar: [
          { id: "M.5.3.1.1", name: "Araştırma soruları üretir, veri toplar ve düzenler."},
          { id: "M.5.3.1.2", name: "Sıklık tablosu ve sütun grafiği oluşturur." },
          { id: "M.5.3.1.3", name: "Bir veri grubuna ait aritmetik ortalamayı hesaplar ve yorumlar." },
        ]
      },
      { 
        id: "5-5", 
