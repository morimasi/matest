    ...
    units: [
      { 
        ...
        kazanimlar: [
          ...
          { id: "M.1.1.1.2", name: "Nesne sayısı 20’ye kadar olan bir topluluktaki nesnelerin sayısını belirler ve bu sayıyı rakamla yazar." },
          { id: "M.1.1.1.3", name: "20’ye kadar olan sayıları ileriye ve geriye doğru birer birer ritmik sayar." },
          ...
          { id: "M.1.1.2.2", name: "Toplamları 20’ye kadar olan doğal sayılarla toplama işlemini yapar." },
          ...
          { id: "M.1.1.3.2", name: "20’ye kadar olan doğal sayılarla çıkarma işlemini yapar." },
  ...
  // 2. Sınıf
  {
    ...
    units: [
      { 
        ...
        name: "Sayılar ve İşlemler", 
        kazanimlar: [
          { id: "M.2.1.1.1", name: "100’den küçük doğal sayıları okur ve yazar." }, 
          { id: "M.2.1.1.2", name: "100 içinde ikişer, beşer ve onar; 30 içinde üçer; 40 içinde dörder ileriye ve geriye doğru sayar." },
          { id: "M.2.1.1.3", name: "100’den küçük doğal sayıların basamaklarını adlandırır, basamaklarındaki rakamların basamak değerlerini belirtir." },
          { id: "M.2.1.1.4", name: "100’den küçük doğal sayıları karşılaştırır ve sıralar." },
          { id: "M.2.1.2.1", name: "Eldeli ve eldesiz toplama işlemini yapar." }, 
          ...
          { id: "M.2.1.3.1", name: "Onluk bozarak ve bozmadan çıkarma işlemi yapar." }, 
    ...
    units: [
      { 
        ...
        kazanimlar: [
          ...
          { id: "M.3.1.1.2", name: "1000 içinde yüzer, onar ve birer ileriye doğru ritmik sayar." },
          { id: "M.3.1.1.3", name: "Üç basamaklı doğal sayıları karşılaştırır ve sıralar." },
          { id: "M.3.1.1.4", name: "Tek ve çift doğal sayıları belirtir." },
          { id: "M.3.1.2.1", name: "Üç basamaklı sayılarla toplama ve çıkarma işlemleri yapar." },
          { id: "M.3.1.2.2", name: "Zihinden toplama ve çıkarma işlemleri yapar." },
          { id: "M.3.1.3.1", name: "Üç basamaklı bir doğal sayı ile bir basamaklı bir doğal sayıyı çarpar." },
          { id: "M.3.1.3.2", name: "Çarpma işleminin özelliklerini kullanır." },
          { id: "M.3.1.4.1", name: "İki basamaklı bir doğal sayıyı bir basamaklı bir doğal sayıya böler." },
          { id: "M.3.1.4.2", name: "Bölme işleminde kalanı yorumlar." },
          { id: "M.3.1.5.1", name: "Birim kesirleri tanır ve modellerle gösterir." },
          { id: "M.3.1.5.2", name: "Bir bütünün belirtilen birim kesir kadarını belirler." },
        ] 
      },
      { 
        id: "3-2", 
        ...
        kazanimlar: [
          ...
          { id: "M.3.2.3.1", name: "Şekillerin simetri doğrularını çizer." },
        ]
      },
      { 
        id: "3-3", 
        name: "Ölçme", 
        kazanimlar: [
          { id: "M.3.3.1.1", name: "Metre ve santimetre arasındaki ilişkiyi açıklar." },
    ...
    units: [
      { 
        ...
        kazanimlar: [
          ...
          { id: "M.4.1.1.2", name: "Sayı örüntüleri oluşturur." },
          { id: "M.4.1.2.1", name: "En çok dört basamaklı doğal sayılarla toplama ve çıkarma işlemi yapar." },
          { id: "M.4.1.2.2", name: "Zihinden toplama ve çıkarma işlemi yapar." },
          { id: "M.4.1.3.1", name: "En çok üç basamaklı bir doğal sayı ile en çok iki basamaklı bir doğal sayıyı çarpar." },
          { id: "M.4.1.3.2", name: "En çok dört basamaklı bir doğal sayıyı en çok iki basamaklı bir doğal sayıya böler." },
          { id: "M.4.1.4.1", name: "Basit, bileşik ve tam sayılı kesirleri tanır ve modellerle gösterir." },
          { id: "M.4.1.4.2", name: "Kesirleri karşılaştırır ve sıralar." },
          { id: "M.4.1.4.3", name: "Kesirlerle toplama ve çıkarma işlemi yapar." },
          { id: "M.4.1.5.1", name: "Ondalık gösterimlerin anlamını açıklar." },
          { id: "M.4.1.5.2", name: "Ondalık gösterimleri verilen sayıları karşılaştırır." },
        ]
      },
      { 
        id: "4-2", 
      ...
      { 
        ...
        name: "Ölçme", 
        kazanimlar: [
          { id: "M.4.3.1.1", name: "Dikdörtgenin alanını hesaplar."},
          { id: "M.4.3.1.2", name: "Alanı ile ilgili problemleri çözer." },
          { id: "M.4.3.2.1", name: "Zaman ölçü birimleri arasındaki ilişkiyi açıklar."},
          { id: "M.4.3.2.2", name: "Zaman ölçme birimleri ile ilgili problemleri çözer." },
          { id: "M.4.3.3.1", name: "Uzunluk ölçme birimleri ile ilgili problemleri çözer." },
          { id: "M.4.3.3.2", name: "Kare ve dikdörtgenin çevre uzunlukları ile kenar uzunlukları arasındaki ilişkiyi açıklar." },
        ]
      },
      { 
        id: "4-4", 
      ...
      { 
        ...
        name: "Cebir", 
        kazanimlar: [
          { id: "M.4.5.1.1", name: "Sayı örüntülerindeki ilişkiyi bulur."}
        ]
      },
    ],
  },
    ...
    units: [
      { 
        ...
        kazanimlar: [
          ...
          { id: "M.5.1.1.3", name: "Sayı ve şekil örüntüleri oluşturur." },
          ...
          { id: "M.5.1.3.2", name: "Kesirlerle toplama ve çıkarma işlemi yapar." },
          { id: "M.5.1.3.3", name: "Bir çokluğun belirtilen bir basit kesir kadarını ve basit kesir kadarı verilen bir çokluğun tamamını bulur." },
          { id: "M.5.1.3.4", name: "Ondalık gösterimleri okur ve yazar." },
          { id: "M.5.1.3.5", name: "Ondalık gösterimlerde basamak değerlerini belirler." },
          { id: "M.5.1.4.1", name: "Yüzdeleri, kesir ve ondalık gösterimle ilişkilendirir." },
          { id: "M.5.1.4.2", name: "Bir çokluğun belirtilen bir yüzdesine karşılık gelen miktarı bulur." },
        ] 
      },
      { 
        id: "5-2", 
      ...
      { 
        ...
        name: "Ölçme", 
        kazanimlar: [
          { id: "M.5.3.1.1", name: "Dikdörtgenin alanını hesaplamayı gerektiren problemleri çözer." },
          { id: "M.5.3.1.2", name: "Üçgenin alanını hesaplar." },
          { id: "M.5.3.2.1", name: "Dikdörtgenler prizmasının yüzey alanını hesaplar."},
          { id: "M.5.3.2.2", name: "Dikdörtgenler prizmasının hacmini standart birimlerle tahmin eder." },
          { id: "M.5.3.2.3", name: "Dikdörtgenler prizmasının hacmini hesaplar." },
          { id: "M.5.3.3.1", name: "Zaman ölçü birimlerini (yıl, ay, hafta, gün) birbirine dönüştürür." },
          { id: "M.5.3.3.2", name: "Uzunluk ölçme birimlerini (km, m, cm, mm) birbirine dönüştürür." },
          { id: "M.5.3.3.3", name: "Sıvı ölçme birimlerini (L, mL) birbirine dönüştürür." },
        ]
      },
      { 
        id: "5-4", 
        ...
        kazanimlar: [
          ...
          { id: "M.5.4.2.1", name: "Veri analizi ve yorumlama yapar."},
          { id: "M.5.4.2.2", name: "Bir veri grubuna ait aritmetik ortalamayı hesaplar ve yorumlar." },
        ]
      },
      { 
        id: "5-5", 
        name: "Cebir", 
        kazanimlar: [
          { id: "M.5.5.1.1", name: "Cebirsel ifadelerin anlamını açıklar."},
          { id: "M.5.5.1.2", name: "Basit cebirsel ifadeleri farklı biçimlerde yazar." },
        ]
      },
    ],
  },
